...
function latex2svg( formel, name, aufraeumen=true )
  ...
  fprintf(fid,["\\documentclass{standalone} %% Nur die Formel\n" ...
    "\\standaloneconfig{border=0.5bp} %% Sicherstellen das etwas Rand dabei ist\n" ...
    "\\usepackage{arev}	%% arial, serifenfreie Schrift ist besser für 3D Druck und Fräsen\n" ...
    "\\begin{document}\n\\begin{math}\n"]);
